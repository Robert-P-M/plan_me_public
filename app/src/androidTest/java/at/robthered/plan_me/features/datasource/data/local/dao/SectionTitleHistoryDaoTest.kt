...
class SectionTitleHistoryDaoTest : KoinTest {
    ...
    fun getForSection_shouldReturnFilteredAndSortedList() = runTest {
        ...
        historyDao.insert(createHistory(sectionId = otherParentId, text = "Other History", createdAt = 300L))
        ...
        assertThat(historyForSection.map { it.text }).containsExactly("Title v1", "Title v2").inOrder()
    }
    ...
    fun delete_byHistoryId_shouldRemoveCorrectEntry() = runTest {
        // GIVEN
        val parentId = sectionDao.insert(createSection(1, "My Section"))
        val idToDelete = historyDao.insert(createHistory(sectionId = parentId, text = "History 1", createdAt = 100L))
        val idToKeep = historyDao.insert(createHistory(sectionId = parentId, text = "History 2", createdAt = 200L))
    ...
    private fun createHistory(sectionId: Long, text: String, createdAt: Long): SectionTitleHistoryEntity {
