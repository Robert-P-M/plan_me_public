...
class LocalHashtagNameHistoryRepositoryImplTest: KoinTest {
    ...
    fun getById_afterInsert_returnsCorrectlyMappedModel() = runTest {
        // GIVEN
        val historyToInsert = HashtagNameHistoryModel(hashtagId = 1L, text = "New Name", createdAt = testTime)
    ...
    fun getForHashtag_whenMultipleEntriesExist_returnsCompleteList() = runTest {
        // GIVEN
        localHashtagNameHistoryRepository.insert(HashtagNameHistoryModel(hashtagId = 1L, text = "History 1", createdAt = testTime))
        localHashtagNameHistoryRepository.insert(HashtagNameHistoryModel(hashtagId = 1L, text = "History 2", createdAt = testTime))
    ...
    fun deleteById_removesOnlySpecifiedEntry() = runTest {
        // GIVEN
        val historyIdToDelete = localHashtagNameHistoryRepository.insert(HashtagNameHistoryModel(hashtagId = 1L, text = "History to delete", createdAt = testTime))
        val historyIdToKeep = localHashtagNameHistoryRepository.insert(HashtagNameHistoryModel(hashtagId = 1L, text = "History to keep", createdAt = testTime))
