...
class LocalTaskCompletedHistoryRepositoryImplTest : KoinTest {
    ...
    fun getById_afterInsert_returnsCorrectlyMappedModel() = runTest {
        // GIVEN
        val historyToInsert = TaskCompletedHistoryModel(taskId = 1L, isCompleted = true, createdAt = testTime)
    ...
    fun getForTask_whenMultipleEntriesExist_returnsCompleteList() = runTest {
        // GIVEN
        localTaskCompletedHistoryRepository.insert(TaskCompletedHistoryModel(taskId = 1L, isCompleted = false, createdAt = testTime))
        localTaskCompletedHistoryRepository.insert(TaskCompletedHistoryModel(taskId = 1L, isCompleted = true, createdAt = testTime))
    ...
    fun deleteById_removesOnlySpecifiedEntry() = runTest {
        // GIVEN
        val historyIdToDelete = localTaskCompletedHistoryRepository.insert(TaskCompletedHistoryModel(taskId = 1L, isCompleted = true, createdAt = testTime))
        val historyIdToKeep = localTaskCompletedHistoryRepository.insert(TaskCompletedHistoryModel(taskId = 1L, isCompleted = false, createdAt = testTime))
