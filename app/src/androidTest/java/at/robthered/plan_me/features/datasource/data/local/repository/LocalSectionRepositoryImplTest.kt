...
class LocalSectionRepositoryImplTest : KoinTest {
    ...
    fun insertAndGetById_shouldReturnCorrectData() = runTest {
        // GIVEN
        val sectionToInsert = SectionModel(title = "New Section", createdAt = testTime, updatedAt = testTime)
    ...
    fun upsert_shouldUpdateExistingSection() = runTest {
        ...
        // WHEN
        val updatedSection = SectionModel(sectionId = initialId, title = "Updated Title", createdAt = testTime, updatedAt = testTime)
