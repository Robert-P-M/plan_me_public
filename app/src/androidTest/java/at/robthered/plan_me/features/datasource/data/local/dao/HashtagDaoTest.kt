...
class HashtagDaoTest: KoinTest {
    ...
    fun delete_whenHashtagIsParent_cascadesDeleteToCrossRef() = runTest {
        // GIVEN
        val taskId = taskDao.insert(TaskEntity(taskId = 1, title = "Task 1", createdAt = 1L, updatedAt = 1L))
        val hashtagIdToDelete = hashtagDao.insert(HashtagEntity(name = "#to_delete", createdAt = 1L, updatedAt = 1L))
