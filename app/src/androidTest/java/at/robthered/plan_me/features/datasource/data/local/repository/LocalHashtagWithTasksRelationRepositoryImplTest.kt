...
class LocalHashtagWithTasksRelationRepositoryImplTest  : KoinTest {
    ...
    fun getHashtagWithTasks_whenRelationsExist_returnsCorrectlyPopulatedModel() = runTest {
        ...
        taskHashtagsCrossRefDao.insert(TaskHashtagsCrossRefEntity(taskId1, hashtagId, testTime.toEpochMilliseconds()))
        taskHashtagsCrossRefDao.insert(TaskHashtagsCrossRefEntity(taskId2, hashtagId, testTime.toEpochMilliseconds()))
