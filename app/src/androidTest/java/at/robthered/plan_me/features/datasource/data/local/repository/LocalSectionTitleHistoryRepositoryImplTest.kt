...
class LocalSectionTitleHistoryRepositoryImplTest : KoinTest {
    ...
    fun getById_afterInsert_returnsCorrectlyMappedModel() = runTest {
        // GIVEN
        val historyToInsert = SectionTitleHistoryModel(sectionId = 1L, text = "New Section Title", createdAt = testTime)
    ...
    fun getForSection_whenMultipleEntriesExist_returnsCompleteList() = runTest {
        // GIVEN
        localSectionTitleHistoryRepository.insert(SectionTitleHistoryModel(sectionId = 1L, text = "History 1", createdAt = testTime))
        localSectionTitleHistoryRepository.insert(SectionTitleHistoryModel(sectionId = 1L, text = "History 2", createdAt = testTime))
    ...
    fun deleteById_removesOnlySpecifiedEntry() = runTest {
        // GIVEN
        val historyIdToDelete = localSectionTitleHistoryRepository.insert(SectionTitleHistoryModel(sectionId = 1L, text = "History to delete", createdAt = testTime))
        val historyIdToKeep = localSectionTitleHistoryRepository.insert(SectionTitleHistoryModel(sectionId = 1L, text = "History to keep", createdAt = testTime))
