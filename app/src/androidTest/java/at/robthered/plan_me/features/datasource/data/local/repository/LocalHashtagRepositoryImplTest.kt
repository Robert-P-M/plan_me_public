...
class LocalHashtagRepositoryImplTest : KoinTest {
    ...
    fun insertAndGetById_shouldReturnCorrectData() = runTest {
        // GIVEN
        val hashtagToInsert = HashtagModel(name = "test", createdAt = testTime, updatedAt = testTime)
    ...
    fun getAll_shouldReturnAllInsertedHashtags() = runTest {
        // GIVEN
        localHashtagRepository.insert(HashtagModel(name = "kotlin", createdAt = testTime, updatedAt = testTime))
        localHashtagRepository.insert(HashtagModel(name = "android", createdAt = testTime, updatedAt = testTime))
