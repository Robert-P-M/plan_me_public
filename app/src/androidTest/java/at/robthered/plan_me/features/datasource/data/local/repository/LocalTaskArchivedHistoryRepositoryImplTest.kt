...
class LocalTaskArchivedHistoryRepositoryImplTest : KoinTest {
    ...
    fun getById_afterInsert_returnsCorrectlyMappedModel() = runTest {
        // GIVEN
        val historyToInsert =
            TaskArchivedHistoryModel(taskId = 1L, isArchived = true, createdAt = testTime)
    ...
    fun deleteById_removesOnlySpecifiedEntry() = runTest {
        // GIVEN
        val historyIdToDelete = localTaskArchivedHistoryRepository.insert(
            TaskArchivedHistoryModel(
                taskId = 1L,
                isArchived = true,
                createdAt = testTime
        ...
        val historyIdToKeep = localTaskArchivedHistoryRepository.insert(
            TaskArchivedHistoryModel(
                taskId = 1L,
                isArchived = false,
                createdAt = testTime
