...
class LocalTaskTitleHistoryRepositoryImplTest : KoinTest {
    ...
    fun getById_whenHistoryExists_returnsCorrectModel() = runTest {
        // GIVEN
        val historyToInsert = TaskTitleHistoryModel(taskId = 1L, text = "Specific Title", createdAt = testTime)
    ...
    fun getForTask_whenMultipleEntriesExist_returnsCompleteList() = runTest {
        // GIVEN
        localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = 1L, text = "History 1", createdAt = testTime))
        localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = 1L, text = "History 2", createdAt = testTime))
    ...
    fun deleteById_whenEntryExists_removesOnlyThatEntry() = runTest {
        // GIVEN
        val historyIdToDelete = localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = 1L, text = "History to delete", createdAt = testTime))
        val historyIdToKeep = localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = 1L, text = "History to keep", createdAt = testTime))
    ...
    fun insertAndGetForTask_shouldReturnCorrectHistoryForTask() = runTest {
        ...
        val historyToInsert =
            TaskTitleHistoryModel(taskId = parentTask.taskId, text = "New Title", createdAt = Clock.System.now())
    ...
    fun delete_onCascade_shouldDeleteHistoryWhenParentTaskIsDeleted() = runTest {
        ...
        localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = parentTask.taskId, text = "History 1", createdAt = testTime))
        localTaskTitleHistoryRepository.insert(TaskTitleHistoryModel(taskId = parentTask.taskId, text = "History 2", createdAt = testTime))

        val historyBeforeDelete = localTaskTitleHistoryRepository.getForTask(parentTask.taskId).first()
        ...
        // THEN
        val historyAfterDelete = localTaskTitleHistoryRepository.getForTask(parentTask.taskId).first()
        assertThat(historyAfterDelete).isEmpty()
    }
}