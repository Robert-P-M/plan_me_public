...
fun DeleteTaskDescriptionHistorySuccessMessage.toUiText(): UiText {
    return when (this) {
        DeleteTaskDescriptionHistorySuccessMessage.DELETE_TASK_DESCRIPTION_HISTORY_COMPLETED -> {
            UiText.StringResource(
                id = R.string.success_message_task_description_history
            )
        }
    }
}