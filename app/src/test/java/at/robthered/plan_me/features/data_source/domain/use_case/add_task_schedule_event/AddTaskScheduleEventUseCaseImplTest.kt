...
class AddTaskScheduleEventUseCaseImplTest {
    ...
    private lateinit var useCase: AddTaskScheduleEventUseCase
    ...
    fun setUp() {
        ...
        clearMocks(
            transactionProvider, getTaskModelUseCase, localTaskRepository,
            localTaskScheduleEventRepository, safeDatabaseResultCall,
            notificationContentMapper, appAlarmScheduler, clock
        )
        useCase = AddTaskScheduleEventUseCaseImpl(
            transactionProvider, getTaskModelUseCase, localTaskRepository,
            localTaskScheduleEventRepository, safeDatabaseResultCall,
            notificationContentMapper, appAlarmScheduler, clock
        )
