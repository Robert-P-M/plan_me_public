...
class AddTaskUseCaseImplTest {
    ...
    @MockK
    private lateinit var addTaskScheduleEventUseCase: AddTaskScheduleEventUseCase
    ...
    fun setUp() {
        ...
        addTaskUseCase = AddTaskUseCaseImpl(
            ...
            createTaskHashtagCrossRefUseCase = createTaskHashtagCrossRefUseCase,
            safeDatabaseResultCall = safeDatabaseResultCall,
            clock = clock,
            createTaskTitleHistoryUseCase = createTaskTitleHistoryUseCase,
            createTaskDescriptionHistoryUseCase = createTaskDescriptionHistoryUseCase,
            createTaskPriorityHistoryUseCase = createTaskPriorityHistoryUseCase,
            addTaskScheduleEventUseCase = addTaskScheduleEventUseCase
        )
        coEvery {
