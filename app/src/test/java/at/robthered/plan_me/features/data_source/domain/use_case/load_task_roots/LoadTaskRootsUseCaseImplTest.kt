...
class LoadTaskRootsUseCaseImplTest {
    ...
    private lateinit var loadTaskRootsUseCase: LoadTaskRootsUseCase

    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        clearMocks(localTaskRepository, localSectionRepository)
        loadTaskRootsUseCase = LoadTaskRootsUseCaseImpl(localTaskRepository, localSectionRepository)
    }
