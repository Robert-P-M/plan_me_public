...
class GetInboxScreenTasksUseCaseImplTest {
    ...
    fun setUp() {
        ...
        clearMocks(getRootTaskModelsUseCase, recursiveTaskWithHashtagsAndChildrenModelHelper)
        getInboxScreenTasksUseCase = GetInboxScreenTasksUseCaseImpl(
