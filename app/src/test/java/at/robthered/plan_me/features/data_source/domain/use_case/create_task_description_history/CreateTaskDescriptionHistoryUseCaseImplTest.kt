...
class CreateTaskDescriptionHistoryUseCaseImplTest {
    ...
    fun setUp() {
        ...
        clearMocks(localTaskDescriptionHistoryRepository, safeDatabaseResultCall, clock)
        createTaskDescriptionHistoryUseCase = CreateTaskDescriptionHistoryUseCaseImpl(
