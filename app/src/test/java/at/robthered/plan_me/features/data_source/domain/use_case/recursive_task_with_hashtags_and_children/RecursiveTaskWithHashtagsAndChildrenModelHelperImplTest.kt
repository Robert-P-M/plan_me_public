...
class RecursiveTaskWithHashtagsAndChildrenModelHelperImplTest {

    @MockK
    private lateinit var getTaskModelsForParentUseCase: GetTaskModelsForParentUseCase

    private lateinit var recursiveHelper: RecursiveTaskWithHashtagsAndChildrenModelHelper

    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        clearMocks(getTaskModelsForParentUseCase)
        recursiveHelper =
            RecursiveTaskWithHashtagsAndChildrenModelHelperImpl(getTaskModelsForParentUseCase)
    }
