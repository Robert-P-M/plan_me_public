...
class DeleteTaskPriorityHistoryUseCaseImplTest {
    ...
    private lateinit var deleteTaskPriorityHistoryUseCase: DeleteTaskPriorityHistoryUseCase

    @Suppress("UNCHECKED_CAST")
    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        clearMocks(localTaskPriorityHistoryRepository, transactionProvider, safeDatabaseResultCall)
        deleteTaskPriorityHistoryUseCase = DeleteTaskPriorityHistoryUseCaseImpl(
