...
class LoadTaskStatisticsUseCaseImplTest {

    @MockK
    private lateinit var taskStatisticsBuilder: TaskStatisticsBuilder
    @MockK
    ...
    private lateinit var loadTaskStatisticsUseCase: LoadTaskStatisticsUseCase

    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        clearMocks(
            taskStatisticsBuilder, getTaskHistoryFlowHelper,
            localTaskRepository, localTaskHashtagsCrossRefRepository
        )
        loadTaskStatisticsUseCase = LoadTaskStatisticsUseCaseImpl(
            taskStatisticsBuilder, getTaskHistoryFlowHelper,
            localTaskRepository, localTaskHashtagsCrossRefRepository
        )
    }
