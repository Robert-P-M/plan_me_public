...
class AddNewHashtagUseCaseImplTest {
    ...
    private lateinit var addNewHashtagUseCase: AddNewHashtagUseCase
    ...
    fun setUp() {
        ...
        clearMocks(
            ...
            addHashtagHelper, safeDatabaseResultCall, clock
        )
        addNewHashtagUseCase = AddNewHashtagUseCaseImpl(
            transactionProvider, localTaskHashtagsCrossRefRepository,
            addHashtagHelper, safeDatabaseResultCall, clock
        )
