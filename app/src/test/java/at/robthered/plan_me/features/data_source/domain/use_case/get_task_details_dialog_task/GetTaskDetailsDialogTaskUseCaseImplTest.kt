...
class GetTaskDetailsDialogTaskUseCaseImplTest {

    @MockK
    private lateinit var getTaskByIdUseCase: GetTaskByIdUseCase

    @MockK
    private lateinit var recursiveTaskWithHashtagsAndChildrenModelHelper: RecursiveTaskWithHashtagsAndChildrenModelHelper

    private lateinit var getTaskDetailsDialogTaskUseCase: GetTaskDetailsDialogTaskUseCase

    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        clearMocks(getTaskByIdUseCase, recursiveTaskWithHashtagsAndChildrenModelHelper)
        getTaskDetailsDialogTaskUseCase = GetTaskDetailsDialogTaskUseCaseImpl(
            getTaskByIdUseCase,
