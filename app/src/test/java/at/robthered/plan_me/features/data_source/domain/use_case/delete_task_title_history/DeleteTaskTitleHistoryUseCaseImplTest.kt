...
class DeleteTaskTitleHistoryUseCaseImplTest: BaseKoinTest() {
    ...
    override val useCaseModule: Module
        get() = module {
            factoryOf(::DeleteTaskTitleHistoryUseCaseImpl){
                bind<DeleteTaskTitleHistoryUseCase>()
            }
        }
    private val deleteTaskTitleHistoryUseCase: DeleteTaskTitleHistoryUseCase by inject()
