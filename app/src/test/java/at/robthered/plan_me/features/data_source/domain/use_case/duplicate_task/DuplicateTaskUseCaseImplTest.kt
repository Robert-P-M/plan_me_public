...
class DuplicateTaskUseCaseImplTest {
    ...
    @MockK
    private lateinit var createTaskDescriptionHistoryUseCase: CreateTaskDescriptionHistoryUseCase
    @MockK
    ...
    private lateinit var duplicateTaskUseCase: DuplicateTaskUseCase
    ...
    fun setUp() {
        ...
        clearMocks(
            transactionProvider, localTaskRepository, getTaskModelUseCase,
            createTaskTitleHistoryUseCase, createTaskDescriptionHistoryUseCase,
            createTaskPriorityHistoryUseCase, safeDatabaseResultCall, clock
        )
        duplicateTaskUseCase = DuplicateTaskUseCaseImpl(
            transactionProvider, localTaskRepository, getTaskModelUseCase,
            createTaskTitleHistoryUseCase, createTaskDescriptionHistoryUseCase,
            createTaskPriorityHistoryUseCase, safeDatabaseResultCall, clock
        )
